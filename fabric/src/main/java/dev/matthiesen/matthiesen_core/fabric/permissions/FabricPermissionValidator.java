package dev.matthiesen.matthiesen_core.fabric.permissions;
...
public final class FabricPermissionValidator implements PermissionValidator {
    ...
    public void initialize() {
        MatthiesenCoreCommon.INSTANCE.createInfoLog("Booting FabricPermissionValidator, permissions will be checked using fabric-permissions-api, see https://github.com/lucko/fabric-permissions-api");
    }
