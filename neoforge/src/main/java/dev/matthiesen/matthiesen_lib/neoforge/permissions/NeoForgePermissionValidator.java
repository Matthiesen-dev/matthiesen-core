package dev.matthiesen.matthiesen_lib.neoforge.permissions;
...
public final class NeoForgePermissionValidator implements PermissionValidator {
    ...
    private List<PermissionNode<?>> createNodes() {
        PermissionsManager permissionsManager = MatthiesenLibCommon.INSTANCE.getPermissionsManager();
        MatthiesenLibCommon.INSTANCE.createInfoLog("Trying to Register " + permissionsManager.getPendingPermissionCount() + " NeoForge permission nodes");
