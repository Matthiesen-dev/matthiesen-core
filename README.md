...
- **Event Handling**: Listen to and handle game events across different platforms. See [docs/platform-events.md](docs/platform-events.md) for server-side events and [docs/platform-client-events.md](docs/platform-client-events.md) for client-side events.
