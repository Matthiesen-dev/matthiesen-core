package dev.matthiesen.matthiesen_lib.common.core.permissions;
...
public final class VanillaPermissionValidator implements PermissionValidator {
    ...
    public void initialize() {
        MatthiesenLibCommon.INSTANCE.createInfoLog("Booting VanillaPermissionValidator, permissions will be checked using Minecraft's permission level system, see https://minecraft.wiki/w/Permission_level");
    }
