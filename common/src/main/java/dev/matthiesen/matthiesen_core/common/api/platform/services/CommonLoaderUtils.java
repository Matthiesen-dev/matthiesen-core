...
public interface CommonLoaderUtils {
    ...
    /**
     * Get the loader platform metadata for the current mod loader. This method provides information about the mod loader platform, such as its name and version.
     * The implementation of this method may vary depending on the mod loader, but it generally returns an instance of the LoaderPlatform interface that
     * represents the current mod loader platform. This allows mod developers to access loader-specific functionality in a way that is compatible with multiple
     * mod loaders without having to worry about the specific implementation details of each loader.
     * @return The loader platform metadata for the current mod loader.
     */
    LoaderPlatformMeta getLoaderMeta();
