...
public final class UniversalMetricsServer extends AbstractUniversalMetric {
     ...
     * @param compatibilityLayer the compatibility layer used to access server-specific data and functionality. This allows the metrics implementation to retrieve server-specific information such as online mode and player count, which can be included in the metrics data.
