...
public final class UniversalMetricsClient extends AbstractUniversalMetric {
     ...
     * @param compatibilityLayer the compatibility layer used to access client-specific data and functionality. This allows the metrics implementation to retrieve client-specific information such as online mode and player count, which can be included in the metrics data.
